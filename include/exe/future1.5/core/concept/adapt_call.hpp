...
#ifndef DDVAMP_EXE_FUTURE_CORE_CONCEPT_ADAPT_CALL_HPP_INCLUDED_
#define DDVAMP_EXE_FUTURE_CORE_CONCEPT_ADAPT_CALL_HPP_INCLUDED_ 1
...
#endif /* DDVAMP_EXE_FUTURE_CORE_CONCEPT_ADAPT_CALL_HPP_INCLUDED_ */

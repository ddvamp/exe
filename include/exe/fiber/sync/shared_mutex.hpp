...
#ifndef DDVAMP_EXE_FIBER_SYNC_SHARED_MUTEX_HPP_INCLUDED_
#define DDVAMP_EXE_FIBER_SYNC_SHARED_MUTEX_HPP_INCLUDED_ 1
...
#endif /* DDVAMP_EXE_FIBER_SYNC_SHARED_MUTEX_HPP_INCLUDED_ */

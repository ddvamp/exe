...
#ifndef DDV_EXE_FUTURES_FUN_COMBINE_PAR_DETAIL_USE_COUNT_H_
#define DDV_EXE_FUTURES_FUN_COMBINE_PAR_DETAIL_USE_COUNT_H_ 1
...
#endif /* DDV_EXE_FUTURES_FUN_COMBINE_PAR_DETAIL_USE_COUNT_H_ */

...
#ifndef DDV_EXE_FUTURE_FUN_TYPES_FUTURE_H_
#define DDV_EXE_FUTURE_FUN_TYPES_FUTURE_H_ 1

#include <type_traits>

#include "exe/future/fun/make/contract/fwd.h"
...
#endif /* DDV_EXE_FUTURE_FUN_TYPES_FUTURE_H_ */

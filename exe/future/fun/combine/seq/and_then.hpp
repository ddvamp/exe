...
#ifndef DDVAMP_EXE_FUTURE_FUN_COMBINE_SEQ_AND_THEN_HPP_INCLUDED_
#define DDVAMP_EXE_FUTURE_FUN_COMBINE_SEQ_AND_THEN_HPP_INCLUDED_ 1
...
class [[nodiscard]] AndThen : public detail::Mutator {
...
public:
	...
	explicit AndThen(Fn &&fn) noexcept
...
{
	return pipe::AndThen<Fn>(::std::forward<Fn>(fn));
}

} // namespace exe::future

#endif /* DDVAMP_EXE_FUTURE_FUN_COMBINE_SEQ_AND_THEN_HPP_INCLUDED_ */
